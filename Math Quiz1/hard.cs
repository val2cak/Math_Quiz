...
namespace Math_Quiz1
{
    public partial class hard : Form
    {
        ...
        {
            addend1 = randomizer.Next(101, 1001);
            addend2 = randomizer.Next(101, 1001);
            ...
            minuend = randomizer.Next(101, 1001);
            subtrahend = randomizer.Next(101, 1001);
            minusLeftLabel.Text = minuend.ToString();
            minusRightLabel.Text = subtrahend.ToString();
            difference.Value = 0;

            multiplicand = randomizer.Next(101, 1001);
            multiplier = randomizer.Next(101, 1001);
            timesLeftLabel.Text = multiplicand.ToString();
            timesRightLabel.Text = multiplier.ToString();
            product.Value = 0;

            divisor = randomizer.Next(101, 1001);
